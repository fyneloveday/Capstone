...
namespace Capstone.Models
{
    public class GroupAdminController : Controller
    {
        ...
        {
            ViewBag.MemberModelId = new SelectList(db.MemberModels, "ID", "FirstName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,GroupName,Description,Rules,MemberModelId")] GroupModel groupModel)
        {
